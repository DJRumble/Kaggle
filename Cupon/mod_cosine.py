...
user_profiles.to_csv('output/User_profiles.csv', header=True,  index=False)
train_dropped_coupons.to_csv('output/train_dropped_coupons.csv', header=True,  index=False)
...
output_df_all_users.to_csv('output/cosine_sim_python.csv', header=True,
